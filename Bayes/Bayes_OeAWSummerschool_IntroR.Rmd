---
title: " Bayes at ?AW Summerschool, Ligist"
...
Element of a vector, a matrix or a data.frame square brackets are extracted using square brackets.
```{r}
...
heute <- "Wochenende"
if (heute == "Wochenende") {
  print("Gehe ins Freibad")
} else {
  print("Gehe zur Arbeit")
}
```
